package com.dg.supermariobros.scenes;
...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch sb) {
        ...
        countdownLabel = new Label(String.format("%03d", worldTimer), new Label.LabelStyle(
                new BitmapFont(), Color.WHITE
        ));
        scoreLabel = new Label(String.format("%06d", score), new Label.LabelStyle(
                new BitmapFont(), Color.WHITE
        ));
